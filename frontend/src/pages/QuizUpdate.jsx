	...
	render() {
		return (
			<div className='form-container'>
				...
				></input>
				<button
					className='btn btn-primary button button__shadow'
					onClick={this.handleUpdateQuizName}
				>
					Update
				</button>
				<a className='btn btn-danger button button__shadow' href='/quizzes'>
					Cancel
				</a>
			</div>
		);
